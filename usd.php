...
<body>
	...
	<div class="pt-4">
		<img src="https://memories-travel.com/wp-content/uploads/2019/08/MT-Logo-copy.png" width="100px"
			class="rounded mx-auto d-block" alt="...">

	</div>
	<form action="checkoutusd.php" method="post">
							...
							<table class="table table-sm">
								...
								<tr class="rimproducts">
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/PalaungCabin_Cover.png"
									...
									<td class="rimproducts"><input type="number" name="price-4" readonly="readonly"
											value="600" class="quantity form-control form-control-sm text-center">
									</td>
								...
								<tr class="rimproducts">
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/RubyLand_Cover_withCar.png"
											width="100px" height="100px" alt="..." class="img-thumbnail">
									...
									<td class="rimproducts"><input type="number" name="price-2" readonly="readonly"
											value="230" class="quantity form-control form-control-sm text-center"></td>
								...
								<tr class="rimproducts">
									...
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/YomaAdventure_Cover_withCar.png"
											width="100px" height="100px" alt="..." class="img-thumbnail">
								...
								<tr class="rimproducts">
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/RubyLand_Cover_withoutCar.png"
											width="100px" height="100px" alt="..." class="img-thumbnail">
									...
									<td class="rimproducts"><input type="number" name="price-3" readonly="readonly"
											value="184" class="quantity form-control form-control-sm text-center"></td>
								...
								<tr class="rimproducts">
									...
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/YomaAdventure_Cover_withoutCar.png"
											width="100px" height="100px" alt="..." class="img-thumbnail">
									...
									<td class="rimproducts"><input type="number" name="price-1" readonly="readonly"
											value="161" class="quantity form-control form-control-sm text-center"></td>
								...
								<tr class="rimproducts">
									<td class="rimproducts">
										<img src="https://memoriesgroup.com/wp-content/uploads/2020/08/Child-Packages.png"
											width="100px" height="100px" alt="..." class="img-thumbnail">
									...
									<td class="rimproducts"><input type="number" name="price-5" readonly="readonly"
											value="161" class="quantity form-control form-control-sm text-center">
									</td>
					...
					<div class="card">
						<div class="card-body">
							...
							<button type="submit" name="formSubmit" value="Submit"
								class="btn btn-primary btn-lg btn-block">Continue to payment</button>
						</div>
					</div>
					<div class="pt-4"> </div>
