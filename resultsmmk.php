...
$SECRETKEY = "F6F3908E77CA8E157E6BA6C97A7505DC437282D7D6F0D9EEA9C93C409479177A";
...
// echo "checkHash: ".$checkHash."<br/><br/>";
    ...
    $log .= "\n------------------------\n";
    file_put_contents(getcwd() . '/paymentmmk.log', $log, FILE_APPEND); 



    if ( $payment_status = 000) {
        
        // echo this when success;
